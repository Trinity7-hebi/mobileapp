...
const msgtxt1 = '<p class="image"><img src ="img/penguins.jpg" width=61px heigth=61px><p class="text">Peguins Attack! (your turn)</p>';
const msgtxt2 = '<p class="image"><img src ="img/whitebear.jpg" width=61px heigth=61px><p class="text">WhiteBear Attack! (computer turn)</p>';
const msgtxt3 = '<p class="image"><img src ="img/penguins.jpg" width=61px heigth=61px><p class="text animate__animated animate__lightSpeedInRight">Penguins Win!!</p>';
const msgtxt4 = '<p class="image"><img src ="img/whitebear.jpg" width=61px heigth=61px><p class="text animate__animated animate__lightSpeedInLeft">WhiteBear Win!!</p>';
const msgtxt5 = '<p class="image"><img src ="img/penguins.jpg" width=61px heigth=61px><img src ="img/whitebear.jpg" width=61px heigth=61px></p><p class="text animate__bounceIn">Draw!!</p>';
